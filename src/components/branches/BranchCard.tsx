  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
        ...
        <Link href={`/branches/${branch.id}`}>
          <h3 className="text-lg font-bold text-navy mb-2 hover:text-saffron transition-colors">
            {branch.name}
          </h3>
        </Link>
                ...
                {branch.facilities && branch.facilities.length > 0 && (
                  <div>
                    ...
                    <ul className="grid grid-cols-1 sm:grid-cols-2 gap-1">
                      {branch.facilities.slice(0, 6).map((facility) => (
                        <li
                          key={facility}
        ...
        <Link
          ...
          className="mt-4 inline-flex items-center gap-2 text-saffron font-semibold text-sm hover:text-saffron-dark transition-colors"
        >
